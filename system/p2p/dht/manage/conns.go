...
// FetchConnPeers      Peer's ID           peer       peer.
...
//Less
func (c conns) Less(i, j int) bool { //      ， index=0 ，
...
//Less
func (n netprotocols) Less(i, j int) bool { //      ， index=0 ，
