...
func TestPersistence(t *testing.T) {
	...
	// update 5 key value hash2 tree ，    5 key hash hash2
	var count int
...
func TestIAVLProof(t *testing.T) {
	...
	//key：value  proof，hash1    ,roothash
	index := 9
...
func TestGetHash(t *testing.T) {
	//               hash   ：5f6d625f2d303030303030303030302d
	/*       hash
...
func TestGetObsoleteNode(t *testing.T) {
	...
	require.Equal(t, len(mp), len(obs)) //      ，
	for ob := range obs {
		_, ok := mp[uint64(ob)]
		if !ok {
...
func TestPruningFirstLevelNode(t *testing.T) {
	...
	//      10000 30000 40000 450000
	//       510001,     10000       ,  30000 40000
