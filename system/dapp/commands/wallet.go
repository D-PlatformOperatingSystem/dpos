...
import (
	...
	commandtypes "github.com/D-PlatformOperatingSystem/dpos/system/dapp/commands/types"
...
// AutoMineCmd  set auto mining:           ,        wallet，      ticket
...
func addSendTxFlags(cmd *cobra.Command) {
	...
	cmd.Flags().StringP("token", "t", types.DOM, "token name. (DOM supported)")
}
