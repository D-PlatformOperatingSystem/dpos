...
func testProcSendToAddress(t *testing.T, wallet *Wallet) {
	...
	withdraw := &types.ReqWalletSendToAddress{
		...
		From:   FromAddr,
		Note:   "test",
		To:     "16ctbivFSGPosEWKRwxhSUt6gg9zhPu3jQ",
	}
...
func TestInitSeedLibrary(t *testing.T) {
	...
	//16ctbivFSGPosEWKRwxhSUt6gg9zhPu3jQ ticket
	_, err = wallet.IsTransfer("16ctbivFSGPosEWKRwxhSUt6gg9zhPu3jQ")
	require.NoError(t, err)
