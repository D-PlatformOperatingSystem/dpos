...
import (
	...
	protodata "github.com/D-PlatformOperatingSystem/dpos/common/db/table/proto"
...
func TestJoin(t *testing.T) {
	...
	//query table
	//      ，  tablejoin.MustGetTable("gameaddr")
	//join query   tablejoin.Query
