...
//flage =1    roothash  flage =2    branch  flage =3   roothash   branch
...
//calcSingleLayerMerkleRoot     merkle  hash  fullhash
...
//calcMultiLayerMerkleInfo     merkle  hash  fullhash
//1,            
//2,               （         ）
//3,                 ，     
func calcMultiLayerMerkleInfo(txs []*types.Transaction) ([]byte, []types.ChildChain) {
	...
	//                 。
	//    calcSingleLayerMerkleRoot  roothash  
	if chainCount <= 1 {
