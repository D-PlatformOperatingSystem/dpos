...
SRC := github.com/D-PlatformOperatingSystem/dpos/cmd/dplatformos
SRC_CLI := github.com/D-PlatformOperatingSystem/dpos/cmd/cli
SRC_SIGNATORY := github.com/D-PlatformOperatingSystem/dpos/cmd/signatory-server
SRC_MINER := github.com/D-PlatformOperatingSystem/dpos/cmd/miner_accounts
...
SRC_AUTOTEST := github.com/D-PlatformOperatingSystem/dpos/cmd/autotest
LDFLAGS := -ldflags "-w -s"
BUILD_FLAGS = -ldflags "-X github.com/D-PlatformOperatingSystem/dpos/common/version.GitCommit=`git rev-parse --short=8 HEAD`"
...
all: ## Builds for multiple platforms
	...
	@cp cmd/dplatformos/dom.toml build/
...
execblock: ## Build cli binary
	@go build -v -i -o build/execblock github.com/D-PlatformOperatingSystem/dpos/cmd/execblock
...
addupstream:
	git remote add upstream https://github.com/D-PlatformOperatingSystem/dpos.git
	git remote -v
